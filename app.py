...
# ==========================================
    ...
    bugunun_hedefleri = veri_getir("SELECT ders, bandwidth if False else hedef_soru FROM hedefler WHERE tarih = ?", (bugun,))
    ...
    if not hedef_adetler:
        st.success("🎉 Bugünlük atanmış bir görevin yok, harika!")streamlit as st
import sqlite3
from datetime import datetime
